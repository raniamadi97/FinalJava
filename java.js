...
document.querySelector("#categoryContainer").innerHTML = categorycols;
 ...
 async function showCategoryMeals(category) {
  ...
  console.log(mealsInCategory[0]);
    ...
    document.querySelector("#mealCategoryContainer").innerHTML = catergotyHtml;
...
async function fetchAreas() {
    ...
    document.querySelector("#areaHtml").innerHTML = allAreaCols;


}

async function showAreaMeals(area) {
    console.log('showAreaMeals called with area:', area);
    ...
    console.log('Generated areaHtml:', areaHtml);

    // Append mealsHtml to #areaHtml
    const areaHtmlContainer = document.getElementById('areaHtml');
    areaHtmlContainer.innerHTML = areaHtml;

    console.log('#areaHtml content:', areaHtmlContainer.innerHTML);
}
...
function closeButton(){
    ...
    boxDetail.classList.add('hidden2')
  }
